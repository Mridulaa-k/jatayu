...
MQTT_PORT = 1883
MQTT_TOPIC = "driver_sleep_alert"  # Change this to your topic
...
FRAME_THRESHOLD = 5  # ~0.75 sec for faster sleep detection
...
while True:
    ...
    for face in faces:
        ...
        # Trigger sleep alert if eyes are closed for FRAME_THRESHOLD frames (~0.75 sec)
        if sleep_frame_count >= FRAME_THRESHOLD and not alert_sent:
